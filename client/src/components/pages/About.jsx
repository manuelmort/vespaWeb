                ...
                <div class="row">
                        ...
                        <div className = "row">
                            ...
                            <div className="col-sm p-3">
                                ...
                                <div class="card shadow" style={{width: "15rem"}}>
                                    <img class="card-img-top" src="juan.jpg" alt="Card image cap" style={{minHeight:"300px"}}></img>
                                    <div class="card-body">
                            ...
                            <div className="col-sm p-3">
                                <div class="card shadow" style={{width: "15rem"}}>
                                    <img class="card-img-top" src="rosieFake.jpeg" style={{minHeight:"300px"}} alt="Card image cap"></img>
                                    <div class="card-body">
